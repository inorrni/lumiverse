...
export default function CheckRow({ title, sub, meta, done = false, count = '0 / 1', ink = false, onToggle, last = false, onReview, reviewFilled = false, reviewOpen = false, onPress, review = null }) {
  return (
